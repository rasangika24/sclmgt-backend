...
public class AcademicStaffEntity {
    ...
    @Column(name = "appointmentDateAsSlts") private String appointmentDateAsSlts;
    @Column(name = "gradeOfSlts") private String gradeOfSlts;
    ...
    @Column(name = "fathersProfession") private Integer fathersProfession;
